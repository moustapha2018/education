 ...
 */
final class Version20200331155617 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recette (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, rcategorie_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_49BB6390B03A8386 (created_by_id), INDEX IDX_49BB639012FCAE0F (rcategorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
